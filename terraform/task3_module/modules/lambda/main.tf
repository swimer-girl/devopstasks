...
data "archive_file" "start_scheduler" {
  type        = "zip"
  source_file = "./modules/lambda/start_instances.py"
  output_path = "./modules/lambda/start_instances.zip"
}

data "archive_file" "stop_scheduler" {
  type        = "zip"
  source_file = "./modules/lambda/stop_instances.py"
  output_path = "./modules/lambda/stop_instances.zip"
}
